...
//				graphics.DrawString("CMD", SystemFonts.SmallCaptionFont, Brushes.Black, r);
		...
		*/
		...
		public ProtocolControl()
		{
            ...
            this.tracer.HScrollBar = this.hScrollBar; //Add by Chingsheng for display extention data, 2015-01-14
		...
		protected override void OnLoad(EventArgs e)
		{
            ...
            this.hScrollBar.Dock = DockStyle.Bottom; //Add by Chingsheng for display extention data, 2015-01-14

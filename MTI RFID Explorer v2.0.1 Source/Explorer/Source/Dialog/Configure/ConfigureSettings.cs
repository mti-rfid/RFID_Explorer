       ...
       private  ArrayList m_list = new ArrayList();  
        ...
        public ConfigureSettingsControl( LakeChabotReader reader )
        {
            ...
            {                
                ...
                if (reader.uiModelNameMAJOR == 0x4D303258)//0x4D303258==M02X
                {
                ...
                //Add by Wayne for enable link profile selection function for HP SiP, 2014-08-12
                else if (reader.uiModelNameMAJOR == 0x4D303358) //0x4D303358==M03X
                {
                    profileComboBox.Enabled = true;
                    //Add by Wayne for disable USB interface at M03X model, 2014-08-28
                    rBtn_USB.Enabled = false;
                    btn_Update.Enabled = false;
                    //End by Wayne for disable USB interface at M03X model, 2014-08-28
                //Mod by Wayne for enable functions to fit M06 requirement, 2016-10-21
                    rBtn_UART.Checked = true;
                }
                else if (reader.uiModelNameMAJOR == 0x4D303658)
                {
                    profileComboBox.Enabled = true;
                    rBtn_UART.Enabled = false;
                    btn_Update.Enabled = false;
                ...
                //Add by Wayne for enable link profile selection function for HP SiP, 2014-08-12
                else if (uiModelNameMajor == 0x4D303358) //0x4D303358==M03X
                {
                    profileComboBox.Enabled = true;
                    //Add by Wayne for disable USB interface at M03X model, 2014-08-28
                    rBtn_USB.Enabled = false;
                ...
                //End by Wayne for enable link profile selection function for HP SiP, 2014-08-12
                */
                //End by FJ for model name judgement, 2015-01-22

                //Mod by FJ for model name judgement, 2015-01-22
                if (rfid.Constants.Result.OK != reader.result_sel)
                {
                    btn_Update.Enabled = false;
                    break;
                }

                if (reader.uiModelNameSEL == (uint)enumPORT.ENUM_PORT_USB)
                {
                    rBtn_USB.Checked = true;

...
namespace RFID_Explorer
{
    partial class NXPAuthentication : Form
    {
        ...
        private string tempKey0EPC = "", tempKey1EPC = ""; //Add by FJ enhance NXP authentication function, 2018-04-11
        ...
        public NXPAuthentication(RFID_Explorer.mainForm r_form, LakeChabotReader rm_reader)
        {
			...
			//Add by FJ enhance NXP authentication function, 2018-04-11
            textBoxEPC.Text = "";
            btnInsertKey0.Enabled = false;
            btnActivateKey0.Enabled = false;
            btnInsertKey1.Enabled = false;
            btnActivateKey1.Enabled = false;
			//btnInsertKey.Enabled = false;
            //btnActivateKey.Enabled = false;
			//End by FJ enhance NXP authentication function, 2018-04-11
        }
		
		//Add by FJ enhance NXP authentication function, 2018-04-11
        private void btnGetKey0_Click(object sender, EventArgs e)
        {
            int i;
            ...
            else
            {
                ...
                {
                    getKey0Flag = true;
                    tempKey0EPC = parameters.common.bufMTII[dataEPCStart].ToString("X2");
                    for (i = dataEPCStart + 1; i < dataEPCEnd + 1; i++)
                        tempKey0EPC += "-" + parameters.common.bufMTII[i].ToString("X2");
            ...
            if ( getKey0Flag != true )
            {
                if (textBoxInserKey0.Text.Length == 0 && textBoxInserKey1.Text.Length == 0) textBoxEPC.Text = "";
                MessageDisplay("Get Key0 Fail", "Key0 Information", MessageBoxIcon.Error);
            }
            else
            {
                textBoxEPC.Text = tempKey0EPC;
                textBoxInserKey0.Text = tempKey0;
                btnInsertKey0.Enabled = true;
                btnActivateKey0.Enabled = true;

                MessageDisplay("Get Key0 Success", "Key0 Information", MessageBoxIcon.Information);
            }
        ...
        private void btnGetKey1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    getKey1Flag = true;
                    tempKey1EPC = parameters.common.bufMTII[dataEPCStart].ToString("X2");
                    for (i = dataEPCStart + 1; i < dataEPCEnd + 1; i++)
                        tempKey1EPC += "-" + parameters.common.bufMTII[i].ToString("X2");
            ...
            {
                if (textBoxInserKey0.Text.Length == 0 && textBoxInserKey1.Text.Length == 0) textBoxEPC.Text = "";
                MessageDisplay("Get Key1 Fail", "Key1 Information", MessageBoxIcon.Error);
            }
            else
            {
                textBoxEPC.Text = tempKey1EPC;
                textBoxInserKey1.Text = tempKey1;
                btnInsertKey1.Enabled = true;
                btnActivateKey1.Enabled = true;

                MessageDisplay("Get Key1 Success", "Key1 Information", MessageBoxIcon.Information);   
            }
		...
		*/
		...
		//Add by FJ enhance NXP authentication function, 2018-04-11
        private void btnInsertKey0_Click(object sender, EventArgs e)
        {
            int i, key0Length;
            byte flag = 0, selectOpsFlag = 0, postMatchFlag = 0;
            bool writeKey0Flag = false;
            ...
            else
            {
                ...
                if ( writeKey0Flag != true )
                {
                    textBoxInserKey0.Text = "";
                    if ( textBoxInserKey1.Text.Length == 0 ) textBoxEPC.Text = "";
                    btnInsertKey0.Enabled = false;
                    btnActivateKey0.Enabled = false;
                    MessageDisplay("Insert Key0 Fail", "Key0 Information", MessageBoxIcon.Error);
                }
                else
                {
                    MessageDisplay("Insert Key0 Success", "Key0 Information", MessageBoxIcon.Information);
                }
            }
        }
		//End by FJ enhance NXP authentication function, 2018-04-11
		...
		//Add by FJ enhance NXP authentication function, 2018-04-11
        private void btnInsertKey1_Click(object sender, EventArgs e)
        {
            int i, key1Length;
            byte flag = 0, selectOpsFlag = 0, postMatchFlag = 0;
            bool writeKey1Flag = false;
            
            if ( (textBoxInserKey1.Text.Length / 2) < 16 )
            {
            ...
            else
            {
                ...
                if ( writeKey1Flag != true )
                {
                    textBoxInserKey1.Text = "";
                    if ( textBoxInserKey0.Text.Length == 0 ) textBoxEPC.Text = "";
                    btnInsertKey1.Enabled = false;
                    btnActivateKey1.Enabled = false;
                    MessageDisplay("Insert Key1 Fail", "Key1 Information", MessageBoxIcon.Error);
                }
                else
                {
                    MessageDisplay("Insert Key1 Success", "Key1 Information", MessageBoxIcon.Information);
                }
            }
        }
		//End by FJ enhance NXP authentication function, 2018-04-11
		...
		*/
		...
		//Add by FJ enhance NXP authentication function, 2018-04-11
        private void btnActivateKey0_Click(object sender, EventArgs e)
        {
            byte flag = 0, selectOpsFlag = 0, postMatchFlag = 0;
            bool writeParamActivateKey0Flag = false;
            ...
            else
            {
                ...
                if ( writeParamActivateKey0Flag != true )
                {
                    textBoxInserKey0.Text = "";
                    if ( textBoxInserKey1.Text.Length == 0 ) textBoxEPC.Text = "";
                    btnInsertKey0.Enabled = false;
                    btnActivateKey0.Enabled = false;
                    MessageDisplay("Activate Key0 Fail", "Key0 Information", MessageBoxIcon.Error);
                }
                else
                {
                    MessageDisplay("Activate Key0 Success", "Key0 Information", MessageBoxIcon.Information);
                }
            }
        }
		//End by FJ enhance NXP authentication function, 2018-04-11
		...
		//Add by FJ enhance NXP authentication function, 2018-04-11
        private void btnActivateKey1_Click(object sender, EventArgs e)
        {
            byte flag = 0, selectOpsFlag = 0, postMatchFlag = 0;
            bool writeParamActivateKey1Flag = false;
            ...
            else 
            {
                ...
                if ( writeParamActivateKey1Flag != true )
                {
                    textBoxInserKey1.Text = "";
                    if ( textBoxInserKey0.Text.Length == 0 ) textBoxEPC.Text = "";
                    btnInsertKey1.Enabled = false;
                    btnActivateKey1.Enabled = false;
                    MessageDisplay("Activate Key1 Fail", "Key1 Information", MessageBoxIcon.Error);
                }
                else
                {
                    MessageDisplay("Activate Key1 Success", "Key1 Information", MessageBoxIcon.Information);
                }
            }
        }
		//End by FJ enhance NXP authentication function, 2018-04-11

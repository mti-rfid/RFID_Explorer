...
namespace RFID_Explorer
{
    public partial class OptionsGeneralControl : UserControl
    {
        public OptionsGeneralControl(string[] viewArray)
        {
            ...
            //automaticallyIndexCheckBox.Checked = Properties.Settings.Default.automaticIndex; //Mod by FJ for hiding Summary View Function, 2018-04-11
        ...
        {
            //Properties.Settings.Default.automaticIndex = automaticallyIndexCheckBox.Checked; //Mod by FJ for hiding Summary View Function, 2018-04-11
            Properties.Settings.Default.Save( );
        }

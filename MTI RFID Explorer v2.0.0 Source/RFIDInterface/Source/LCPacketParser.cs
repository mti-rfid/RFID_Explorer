...
//					_commandPacketNumber= (int?)information.GetValue("commandPacketNumber", typeof(int?));
		...
		public class PacketBase
		{
            ...
            public static readonly BitVector32.Section transceiverChip  = BitVector32.CreateSection(0x01, crcResult);
            public static readonly BitVector32.Section serializedTID    = BitVector32.CreateSection(0x01, transceiverChip);
            public static readonly BitVector32.Section extraHardware    = BitVector32.CreateSection(0x01, serializedTID);
			...
			//Add by Chingsheng for display extention data, 2015-01-14
            // Bit 3	Extra valid flag:
            // 0 ?No extra hardware data in the front of inv_data
            // 1 ?Extra hardware data included (8 bytes).
            public enum ExtraResultValues
            {
                Disable = 0,
                Enable = 1
            }
...
*/
        ...
        [Serializable]
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        public class inventory_extra : PacketBase
        {
            public INT8U  phy_ant_port;             // The value is the current physical antenna port during the tag-singulation phase.
            public INT8U  phase;			
            public INT8U  Temperature;              // The value is specified in units of degree-C and a two's complement representation.
            public INT8U  reserved;
            public INT32U frequency;	            // The value is specified in units of kHz.
        }
		//End by Chingsheng for display extention data, 2015-01-14

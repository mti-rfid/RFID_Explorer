...
namespace Global
{
    ...
    {
        // Version information
        RFID_MAJOR_VERSION   = 2,
        RFID_MINOR_VERSION   = 0,
        RFID_RELEASE_VERSION = 0,
...
//===============================Communication=============================
    ...
    public enum ENUM_DEVICE_INFO: uint
    {
        ...
        MTI_VID          = 0x24E9,
        MTI_DEF_PID_2000 = 0x2000,
        MTI_DEF_PID_1000 = 0x1000,
        //Mod by FJ for replaced the PID of RU00-M06, 2016-10-31
        MTI_PID_M06 = 0x4D06,
        //MTI_PID_M06      = 0x5206,
        //End by FJ for replaced the PID of RU00-M06, 2016-10-31
        MTI_PID_824      = 0x0824,
        MTI_PID_861      = 0x0861,
        //MTI_VID     = 0x24E9,
        //MTI_DEF_PID = 0x1000,
        ...
        MTI_PID_M07 = 0x4D07, //Add by Wayne for support M06 and M07 module, 2017-08-09.
    };
    ...
    //Mod by FJ redefined the return value of enum TRANS_RESULT, 2016-06-16
    ...
    */
    //End by FJ redefined the return value of enum TRANS_RESULT, 2016-06-16
   ...
   public enum ENUM_PURGE_HW_BUF : byte
   {
       FT_PURGE_RX = 1,
       FT_PURGE_TX,
       FT_PURGE_TX_RX
...
//===============================Protocol=============================
    public enum ENUM_CMD : byte
    {
        ...
        l8K6C_SET_INVENTORY_RESPONSE_CONTROL = 0x0E,
        l8K6C_GET_INVENTORY_RESPONSE_CONTROL,
        ...
        //Add by Wayne for get advanced inventory information, 2014-12-16
        l8K6C_GET_GUARD_BUF_TAG_NUM,
        l8K6C_GET_GUARD_BUF_TAG_INFO,
        //End by Wayne for get advanced inventory information, 2014-12-16
        ...
        ENG_TEST_GET_ADC_CHANNEL = 0x90,
        ENG_TEST_GET_TEMPERATURE,
        ENG_TEST_CALIBRATE_DC_OFFSET,
        //End by Wayne for change get temperature scenario, 2014-10-09


        //Tag Access Data
        UPDATE_GET_VERSION = 0xE1,
        UPDATE_ENTER_UPDATE_MODE,
        UPDATE_SEND_UPDATE_DATA,
        UPDATE_COMPLETE,
        UPDATE_RESET,
        //Add by Wayne for improve FW upgrade feature for integrate M03X model, 2015-03-31
        UPDATE_GET_MODEL_NAME = 0xE8,
        UPDATE_GET_UPDATE_KEY,
        ...
        l8K6C_TAG_NXP_SPECIFIC = 0xE1, //Add by FJ for NXP authentication function, 2018-02-02
        ...
        //Define by MTI
        COMMAND_TEST = 0xFD, // Add by Chingsheng for Command Test Window, 2015-01-30
        TIME_OUT     = 0xFE,
        NOTHING      = 0xFF
    }
...
//=======================Protocol  value limit==========================
    ...
    public class CGlobalFunc
    {
        ...
        //Add by Wayne for improve FW upgrade feature for integrate M03X model, 2015-03-31
        public static bool CheckUpgradeFileName(string filename)
        {
            bool result = true;

            if (filename.IndexOf("RU-824") == -1 &&
                filename.IndexOf("RU-861") == -1 &&
                filename.IndexOf("RU00-M02") == -1 &&
                //Mod by Wayne for supporting M.2/R2000 module, 2016-08-01
                filename.IndexOf("RU00-M03") == -1 &&
                filename.IndexOf("RU00-M06") == -1 &&
                //filename.IndexOf("RU00-M03") == -1)
                //End by Wayne for supporting M.2/R2000 module, 2016-08-01
                //Add by Wayne for FWUpdateTool support M07 module, 2016-12-16
                filename.IndexOf("RU00-M07") == -1)

    ...
    namespace Constants
    {
        ...
        **/
        ...
        public enum RegionConstant : int
        {
            ...
            //TotalRegion :US!BEU!BEU2!BTW!BCN!BKR!BAU/NZ!BBR!BIL!BIN!BCustomer!BJP!BJP2
            TotalRegion = 13, //Add by FJ for adding the Japan2 region, 2017-08-23
        ...
        public enum NXPSpecificFunID : byte
        {
            ConfigParms = 0,
            TAM1Authenticate = 1,
            TAM2Authenticate = 2
        ...
        **/
        ...
        public enum MacRegion : uint
        {
            ...
            JP,
            JP2, //Add by FJ for adding the Japan2 region, 2017-08-23
            HK,
            MY,
            SG,
            TH,
